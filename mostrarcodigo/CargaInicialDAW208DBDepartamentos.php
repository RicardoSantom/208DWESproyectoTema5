...
<html lang="en">
    <head>
        ...
        <title>Ejercicios Proyecto Tema 5</title>
    </head>
    <body>
        <header>
            <h1>Ejercicios Proyecto Tema 5</h1>
            <h2>Script carga inicial DAW208DAWDBDepartamentos.sql</h2>
        </header>
        <main>
            <article>
                <h3>Enunciado: Mostrar script carga inicial DAW208DAWDBDepartamentos.sql</h3>
                <?php
                /**
                 ...
                 * @since 04/11/2022
                 */
                echo '<h4 style="color:orange">CargaInicialDAW208DBDeparamentos.sql.php</h4>';
                //Imprime como texto por pantalla el contenido del archivo referenciado.
                echo highlight_file("../scriptDB/CargaInicialDAW208DBDepartamentos.sql");
                ?>
            </article>
        </main>
        <footer>

...
<html lang="en">
    <head>
        ...
        <title>Mostrar Fichero Creación DB</title>
    </head>
    <body>
        <header>
            <h1>Script's Proyecto Tema 5</h1>
            <h2>Mostrar Fichero Creación DB + Usuario</h2>
        </header>
        <main>
            <article>
                <h3>Código fichero Creación Base de Datos + Usuario.</h3>
                    <?php highlight_file("../scriptDB/cargaInicialDB.php") ?>
            </article>
        </main>
        <footer>

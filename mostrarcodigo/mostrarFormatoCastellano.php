...
<html lang="en">
    <head>
        ...
        <title>Mostrar Librería Formato Castellano</title>
    </head>
    <body>
        <header>
            <h1>Librerías Proyecto Tema 5</h1>
            <h2>Librería Formato Castellano</h2>
        </header>
        <main>
            <article>
                <h3>Código Librería Formato Castellano.</h3>
                    <?php highlight_file("../core/libreriaFormatoCastellano.php") ?>
            </article>
        </main>
        <footer>

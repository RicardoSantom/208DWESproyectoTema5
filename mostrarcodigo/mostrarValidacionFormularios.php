...
<html lang="en">
    <head>
        ...
        <title>Mostrar Librería Validación Formularios</title>
    </head>
    <body>
        <header>
            <h1>Librerías Proyecto Tema 5</h1>
            <h2>Librería Validación Formularios</h2>
        </header>
        <main>
            <article>
                <h3>Código Librería Validacion Formularios.</h3>
                    <?php highlight_file("../core/validacionFormularios.php") ?>
            </article>
        </main>
        <footer>
